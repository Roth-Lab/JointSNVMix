...
class _Posterior(object):
    def __init__(self, Priors):
        ...
        self.alpha_bar_1 = self.priors.alpha_1
        self.alpha_bar_2 = self.priors.alpha_2
        
        self.beta_bar_1 = self.priors.beta_1
        self.beta_bar_2 = self.priors.beta_2
    ...
    def update(self, ESS):
        ...
        self.alpha_bar_1 = self.priors.alpha_1 + ESS.a_bar_1        
        self.alpha_bar_2 = self.priors.alpha_2 + ESS.a_bar_2
        
        self.beta_bar_1 = self.priors.beta_1 + ESS.b_bar_1     
        self.beta_bar_2 = self.priors.beta_2 + ESS.b_bar_2
