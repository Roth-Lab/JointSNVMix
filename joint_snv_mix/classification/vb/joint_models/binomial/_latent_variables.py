...
class _LatentVariables( object ):
    ...
    def update( self, Posterior ):
        ...
        term_1 = self.a_1 * Posterior.expected_log_mu_1.reshape( shape ) + \
                 self.b_1 * Posterior.expected_log_one_minus_mu_1.reshape( shape )
        
        term_2 = self.a_2 * Posterior.expected_log_mu_2.reshape( shape ) + \
                 self.b_2 * Posterior.expected_log_one_minus_mu_2.reshape( shape )
