...
from jsm_models.em.multinomial.multinomial_latent_variables import MultinomialLatentVariables
...
def joint_multinomial_log_likelihood( data, parameters ):
    ...
    log_likelihoods = np.hstack( ( 
                                 ...
                                 normal_log_likelihoods[:, 3].reshape( column_shape ) + tumour_log_likelihoods ,
                                 normal_log_likelihoods[:, 4].reshape( column_shape ) + tumour_log_likelihoods ,
                                 normal_log_likelihoods[:, 5].reshape( column_shape ) + tumour_log_likelihoods ,
                                 normal_log_likelihoods[:, 6].reshape( column_shape ) + tumour_log_likelihoods ,
                                 normal_log_likelihoods[:, 7].reshape( column_shape ) + tumour_log_likelihoods ,
                                 normal_log_likelihoods[:, 8].reshape( column_shape ) + tumour_log_likelihoods ,
                                 normal_log_likelihoods[:, 9].reshape( column_shape ) + tumour_log_likelihoods
                                 ) )
