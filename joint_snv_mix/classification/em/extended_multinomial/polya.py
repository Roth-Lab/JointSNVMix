...
from jsm_models.utils.log_pdf import log_dirichlet_pdf, log_multivariate_polya_likelihood
...
def joint_multinomial_log_likelihood( data, parameters ):
    ...
    rho_1 = parameters['alpha'][0]
    rho_2 = parameters['alpha'][1]

    
    normal_log_likelihoods = log_multivariate_polya_likelihood( counts_1, rho_1 )
    tumour_log_likelihoods = log_multivariate_polya_likelihood( counts_2, rho_2 )
