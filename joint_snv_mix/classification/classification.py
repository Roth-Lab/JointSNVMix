...
def run_independent_beta_binomial( args ):
    ...
    if args.train:
        ...
        normal_priors, tumour_priors = parse_independent_beta_binomial_priors_file( args.priors_file, n )
        ...
        normal_parameters, tumour_data = parse_independent_beta_binomial_parameters_file( args.params_file_name )
...
def parse_independent_beta_binomial_priors_file( priors_file_name, n ):
...
def parse_independent_beta_binomial_parameters_file( parameters_file_name ):
    parser = ConfigParser.SafeConfigParser()
...
def run_independent_binomial( args ):
    ...
    if args.train:
        ...
        normal_priors, tumour_priors = parse_independent_binomial_priors_file( args.priors_file, n )
        
        normal_parameters = model.train( normal_data, normal_priors, args.max_iters, args.convergence_threshold )
        tumour_parameters = model.train( tumour_data, tumour_priors, args.max_iters, args.convergence_threshold )   
    else:
        normal_parameters, tumour_data = parse_independent_binomial_parameters_file( args.params_file_name )
...
def parse_independent_binomial_priors_file( priors_file_name, n ):
    parser = ConfigParser.SafeConfigParser()
    parser.read( priors_file_name )
...
def parse_independent_binomial_parameters_file( parameters_file_name ):
    parser = ConfigParser.SafeConfigParser()
    parser.read( parameters_file_name )
...
def run_joint_beta_binomial( args ):
    ...
    if args.train:
        ...
        priors = parse_beta_binomial_priors_file( args.priors_file, data.nrows )
        
        writer.write_priors( priors )
        
        parameters = model.train( data, priors, args.max_iters, args.convergence_threshold )
    else:
        parameters = parse_beta_binomial_parameters_file( args.params_file )
...
def parse_beta_binomial_priors_file( priors_file_name, n ):
    parser = ConfigParser.SafeConfigParser()
    parser.read( priors_file_name )
...
def parse_beta_binomial_parameters_file( parameters_file_name ):
    parser = ConfigParser.SafeConfigParser()
    parser.read( parameters_file_name )
...
def run_joint_binomial( args ):
    ...
    if args.train:
        ...
        priors = parse_joint_binomial_priors_file( args.priors_file, data.nrows )
        
        writer.write_priors( priors )
        
        parameters = model.train( data, priors, args.max_iters, args.convergence_threshold )   
    else:
        parameters = parse_joint_binomial_parameters_file( args.params_file_name )
...
def parse_joint_binomial_priors_file( priors_file_name, n ):
    parser = ConfigParser.SafeConfigParser()
    parser.read( priors_file_name )
...
def parse_joint_binomial_parameters_file( parameters_file_name ):
    parser = ConfigParser.SafeConfigParser()
    parser.read( parameters_file_name )
